...
const plans={
 occlusion:{name:'Occlusion Made Easy',count:'October 3, 10:00 a.m. New York time (EDT)',india:2999,regional:39,standard:199,group:'single',rule:'No prerequisite. Join October 3 to qualify for Vertical Dimension on October 17.'},
 vertical:{name:'Vertical Dimension with FMR',count:'October 17, 10:00 a.m. New York time (EDT)',india:2999,regional:39,standard:199,group:'single',rule:'Requires our Occlusion module. Previous attendees already qualify.'},
 rehab:{name:'Occlusion & Rehabilitation',count:'October 3 + October 17, both at 10:00 a.m. New York time (EDT)',india:5499,regional:null,standard:369,group:'two',rule:'Two lectures covering the foundations of our full-mouth rehabilitation teaching. No All-on-X commitment.'},
...
function payment(){
 ...
 const ready=['occlusion','rehab'].includes(pack.value);const enabled=Boolean(href&&(ready||confirmed.checked));
 confirmed.closest('label').style.display=standard&&!ready?'flex':'none';document.getElementById('confirmation-text').textContent=pack.value==='vertical'?'I have completed STABLE Academy’s Occlusion module.':'I have confirmed my intake and prerequisites with Dr Parmar.';
